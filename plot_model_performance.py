...
def plot_network_performance():
    ...
    plot_result_diff_archi(
        get_csv('workdir_1_5/', model_name="luna16_full", manual_labels=False, ndsb3_holdout=0),
        '3DCNN_1_5/luna16_full',
        get_csv('workdir_1_10/', model_name="luna16_full", manual_labels=False, ndsb3_holdout=0),
