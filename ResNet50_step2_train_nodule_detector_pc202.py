...
POS_WEIGHT = 2
NEGS_PER_POS = 5   # NEGS_PER_POS = 20
P_TH = 0.6
...
def get_train_holdout_files(fold_count, train_percentage=80, logreg=True, ndsb3_holdout=0, manual_labels=True, full_luna_set=False, local_patient_set=False):
    ...
    pos_samples = glob.glob(settings.BASE_DIR + "generated_traindata/luna16_train_cubes_lidc/*.png")
    logger.info("Pos samples: {0}".format(len(pos_samples)))

    pos_samples_manual = glob.glob(settings.BASE_DIR + "generated_traindata/luna16_train_cubes_manual/*_pos.png")
    ...
    ndsb3_list = glob.glob(settings.BASE_DIR+ "generated_traindata/ndsb3_train_cubes_manual/*.png")
    ...
    neg_samples_edge = glob.glob(settings.BASE_DIR + "generated_traindata/luna16_train_cubes_auto/*_edge.png")
    ...
    neg_samples_luna = glob.glob(settings.BASE_DIR + "generated_traindata/luna16_train_cubes_auto/*_luna.png")
