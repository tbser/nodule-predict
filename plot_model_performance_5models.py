...
def plot_network_performance(rootdirectory="/opt/data/deeplearning/train_result/"):
    ...
    plot_result_diff_archi(
        get_csv(rootdirectory + '3DCNN/workdir/', model_name="luna16_full", manual_labels=False, ndsb3_holdout=0),
        '3DCNN/luna16_full',
        get_csv(rootdirectory + 'ResNet50/workdir/', model_name="luna16_full", manual_labels=False, ndsb3_holdout=0),
        'RestNet50/luna16_full')
