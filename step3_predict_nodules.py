...
#logger = logging.getLogger('step3_predict_nodule')
...
def predict_cubes(model_path, continue_job, only_patient_id=None, luna16=False, magnification=1, flip=False, train_data=True, holdout_no=-1, ext_name="", fold_count=2):
    logger.info("Predict cubes with model {0}, magnification {1}, train_data {2} ".format(model_path, magnification, train_data))
    if luna16:
